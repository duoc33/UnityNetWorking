...
public class Lesson15_2 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        try
        {
            ...
            HttpWebRequest req = HttpWebRequest.Create(new Uri("http://192.168.11.57:8000/Http_Server/scenery.jpg")) as HttpWebRequest;
            //2.设置请求类型 或 其它相关参数
