...
{
    //协议配置文件所在路径
    private static string PROTO_PATH ="D:\\UnityProject\\UnityWebScript\\Assets\\StreamingAssets\\Protobuf";
    //协议生成可执行文件的路径
    private static string PROTOC_PATH = "D:\\UnityProject\\UnityWebScript\\protoc-21.12-win64\\protoc.exe";
    //C#文件生成的路径
    private static string CSHARP_PATH = "D:\\UnityProject\\UnityWebScript\\Assets\\Lesson_18ProtoBuf\\ProtobufGenerateTest";
    //C++文件生成的路径
