...
public class FtpUpLoadTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        try
        {
            //1.创建一个Ftp连接 "ftp://127.0.0.1/pic.png"中 pic.png是给上传文件的命名和文件类型的定义
